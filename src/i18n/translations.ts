...
export const translations = {
	fr: {
		...
		photography_page: {
			...
			intro:
				'Cette page rassemble mes images par univers. Les noms affichés reprennent le taxon de chaque sujet, dans une présentation simple et cohérente.',
			hero_tagline: 'Le détail du vivant, à 1:1',
			hero_sub:
				'Observation rapprochée des arthropodes et autres petits organismes, la précision de la macro, la passion du terrain.',
			hero_cue: 'Défiler pour faire la mise au point',
			hero_depth_label: 'Profondeur de champ',
			stat_images: 'Images',
			stat_macro: 'Macrophotographies',
			stat_species: 'Espèces',
			macro_title: 'Macrophotographie',
			macro_desc:
				'Une sélection de prises de vue rapprochées autour des arthropodes et autres petits organismes croisés sur le terrain.',
			other_title: 'Autres prises de vue',
			other_desc:
				'Des images plus généralistes, qui prolongent la même recherche de lumière et de détail.',
			specimen_label: 'Fiche du sujet',
			field_authority: 'Autorité taxonomique',
			field_common: 'Nom vernaculaire',
			field_location: "Lieu d'observation",
			field_biology: 'Biologie',
			field_links: 'Références',
			no_meta: 'Fiche détaillée à venir pour ce sujet.',
			...
			contact_text:
				"Tirages, licence d'image, collaboration ou publication scientifique — écrivez-moi directement.",
	...
	en: {
		...
		photography_page: {
			...
			hero_tagline: 'The detail of life, at 1:1',
			hero_sub:
				'Close observation of arthropods and small organisms — the precision of the microscope, the light of the field.',
			hero_cue: 'Scroll to bring into focus',
			hero_depth_label: 'Depth of field',
			stat_images: 'Images',
			stat_macro: 'Macrophotographs',
			stat_species: 'Species',
			macro_title: 'Macrophotography',
			macro_desc:
				'A selection of close-up shots of the insects and small organisms I meet in the field.',
			other_title: 'Other shots',
			other_desc:
				'More general images that continue the same search for light and detail.',
			specimen_label: 'Specimen card',
			field_authority: 'Taxonomic authority',
			field_common: 'Common name',
			field_location: 'Observation location',
			field_biology: 'Biology',
			field_links: 'References',
			no_meta: 'A detailed card for this subject is coming soon.',
			lightbox_prev: 'Previous image',
			lightbox_next: 'Next image',
			view_details: 'View details',
			contact_heading: 'Interested in an image?',
			contact_text:
				'Prints, image licensing, collaboration, or scientific publication — write to me directly.',
